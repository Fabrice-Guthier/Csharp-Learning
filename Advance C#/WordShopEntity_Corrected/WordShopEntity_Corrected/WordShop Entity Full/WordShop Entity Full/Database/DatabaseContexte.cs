...
namespace WordShop_Entity_Full.Database
{
    class DatabaseContexte : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=CEDRICPC\SQLEXPRESS;Database=ReservationEntity;Trusted_Connection=True;Encrypt=False");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Reservation>().HasData(
                new Reservation { ReservationId = 1, AnimalId = 1, ClientId = 1 });
        }
    }
}
