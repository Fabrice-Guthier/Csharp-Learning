...
namespace CDA
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //À décommenter pour voir l'exemple des EventHandlers;
            //ExempleEventHandler();
        }

        public static void ExempleEventHandler()
        {
            Channel channel = new Channel();
            NotificationsManager notificationsManager = new NotificationsManager();

            channel.OnMessageSent += notificationsManager.PlaySound;
            channel.OnMessageSent += notificationsManager.Vibrations;
