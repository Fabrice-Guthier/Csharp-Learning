...
namespace tpPOO_Netflux_1802
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var dbConnection = GestionnaireConnexionSingleton.Instance;
            using (var connection = dbConnection.ObtenirConnexion())
            {
                // Utilisez la connexion pour exécuter des commandes SQL
